    ...
    return (
        <div className="flex items-center justify-between gap-3 py-2 border-b border-[#1f2937] last:border-0">
            ...
            <div className="text-right shrink-0">
                <div className={`font-mono text-sm font-semibold flex items-center justify-end gap-0.5 ${buying ? 'text-[#00ff88]' : 'text-[#ff4444]'}`}>
                ...
                <p className="text-[10px] text-slate-500 font-mono">
                    ...
                    {' · '}
                    {exited
                        ? <span className="text-[#f59e0b]">exited</span>
    ...
    return (
        <div className="bg-[#111827] border border-[#1f2937] rounded-xl shadow-lg overflow-hidden">
            <div className="px-4 py-3 border-b border-[#1f2937]">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-black tracking-tight">
                        What are institutions <span className="text-[#a78bfa]">as a whole</span> doing?
                    </h2>
                </div>
            ...
            {!hasData ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-[#1f2937]">
                    <div className="px-4 py-3">
                        <p className="text-[11px] uppercase tracking-wider font-semibold text-[#00ff88] mb-1">
                            ↑ Accumulating
                        </p>
                    ...
                    <div className="px-4 py-3">
                        <p className="text-[11px] uppercase tracking-wider font-semibold text-[#ff4444] mb-1">
                            ↓ Trimming
                        </p>
