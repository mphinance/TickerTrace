...
// Fund pages are generated on-demand (ISR), never at build time. Pre-rendering
// every fund during `next build` meant a single transient API blip baked a
// permanent 404 into the deploy — exactly what broke /fund/AVUV. On-demand
// generation + the self-healing api.fund() means a blip costs one slow
// request, not a dead page.
