      ...
      <section className="max-w-6xl mx-auto px-6 py-20 border-t border-[#1f2937]">
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          <ChangelogEntry
            date="August 1, 2026"
            tag="feature"
            title="Separated the nav and dashboard into equity and option-income sections — because ARKK and ULTY are not the same kind of fund"
            desc="We've been tracking two fundamentally different things — equity stock-pickers (ARK, Avantis, Amplify, Corgi, Sprott) and option-income funds (YieldMax, Roundhill, Kurv, REX, NestYield, NicholasX) — and the whole UI was treating them the same way. The signals for those two groups are completely different. Active weight, conviction scores, buying streaks, divergences? That's equity language. Strike prices, DTE, covered-call roll logic, put/call ratio? That's income-fund language. So: the nav now has two labeled sections. The left side (📈) is equity tools — Dashboard, Funds, Stocks, Layering, Changes, Holdings. The right side (💰) is income tools — Fund Scores, CBOE Scanner. They're still in one bar, separated by a divider with small emoji labels so you can orient yourself immediately. On the dashboard, there's now a dedicated 'Option Income Funds' section that sits between the FundsGrid and the AI chat. It shows today's full options activity table front and center (was previously buried two clicks deep in the Daily Activity card's Table tab → Options sub-tab), notable option signals from the briefing, the P/C ratio prominently, and quick links to Fund Scores and the CBOE Scanner. The equity signals, sector flow, divergences, and activity heatmaps all live above it unchanged. Both groups are on the same page, just clearly labeled instead of mixed together."
          />
          <ChangelogEntry
            date="August 1, 2026"
            tag="polish"
